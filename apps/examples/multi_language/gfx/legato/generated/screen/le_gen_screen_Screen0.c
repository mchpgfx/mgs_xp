...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_ButtonWidget_0->fn->setPosition(Screen0_ButtonWidget_0, 58, 68);
    Screen0_ButtonWidget_0->fn->setSize(Screen0_ButtonWidget_0, 387, 126);
    Screen0_ButtonWidget_0->fn->setScheme(Screen0_ButtonWidget_0, &WhiteScheme);
    Screen0_ButtonWidget_0->fn->setBorderType(Screen0_ButtonWidget_0, LE_WIDGET_BORDER_LINE);
    Screen0_ButtonWidget_0->fn->setString(Screen0_ButtonWidget_0, (leString*)&string_GoodMorn);
