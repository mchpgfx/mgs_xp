...
// screen IDs
#define screenID_Screen_Splash    0
#define screenID_Screen_Main    1
#define screenID_Screen_Music_Player    2
#define screenID_Screen_Settings    3
#define screenID_Screen_Water_Q    4
